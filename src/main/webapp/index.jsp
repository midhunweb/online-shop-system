            ...
            <div class="slide-visual">
                ...
                <div class="script-wrap">
                    ...
                    <div class="slide-controller">
                        <a href="#" class="btn-prev"><img src="images/btn_previous.png" width="10%" height="10%"
                                                          alt="Prev Slide" /></a> <a href="#" class="btn-play"><img
                                src="images/btn_play.png" width="10%" height="10%"  alt="Start Slide" /></a> <a href="#"
                                                                              class="btn-pause"><img src="images/btn_pause.png" width="10%" height="10%"
                                               alt="Pause Slide" /></a> <a href="#" class="btn-next" ><img
                                src="images/btn_next.png" width="10%" height="10%" alt="Next Slide" /></a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>

...
<html>
    ...
    <body>
        ...
        <div class="checkout">
            <div class="container">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <%
                        ResultSet totalProduct = DatabaseConnection.getResultFromSqlQuery("Select * from tblcart where customer_id='" + session.getAttribute("id") + "'");
                        ...
                        <tr class="rem1">
                                ...
                                <div class="quantity">
                                    <div class="quantity-select">
                                        <form action="UpdateProductQuantity" method="post">
                                            <input type="hidden" value="<%=totalProduct.getInt(4)%>"
                                                   name="productId"> <input type="number"
                                                   name="quantity" value="<%=totalProduct.getInt(5)%>"
                            ...
                            <td class="invert"><del><%=totalProduct.getString(6)%>&nbsp;Rs.
                                </del></td>
                            <td class="invert"><%=totalProduct.getString(7)%>&nbsp;Rs.</td>
                            <td class="invert"><%=totalProduct.getString(8)%>&nbsp;Rs.</td>
                            <td class="invert"><a
                                    href="removeProductFromCart.jsp?productId=<%=totalProduct.getInt(4)%>"
         ...
         <div>
             <input type="button" class="btn btn-info " value="Print Receipt before buying"  onClick="window.print()"/>
        </div>                            
                            
                            <input type="submit" value="Buy Products" class="btn btn-success btn-lg btn-block" onclick="return confirm('Are you sure Do you want to buy this order?');">
                        </div>
                    </div>
                </form>
                <%

                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" action="AddProducts" method="post"
                                    ...
                                    <div class="form-group">
                                        <label>Id</label> <input class="form-control" type="number" name="pid" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Stock</label> <input class="form-control" type="number" name="stock" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Product Category</label> <input class="form-control" type="text" name="pcategory" required/>
                                    </div>
